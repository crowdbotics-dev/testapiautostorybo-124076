...
## Project Structure
    ...
    ├── testapiautostorybo_124076  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_124076`
...
2. Clone this repo and `cd testapiautostorybo_124076`
